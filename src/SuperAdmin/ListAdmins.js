...
useEffect(()=>{
  ...
  axios.get(`https://app-ndoejs.herokuapp.com/admin`)
...
const deleteadmin = (id)=>{
  ...
  if (yesno) {   
axios.delete(`https://app-ndoejs.herokuapp.com/admin/delete/${id}`)
.then(function (response) {
...
let numAdmin =5;
//   axios.get(`hhttps://app-ndoejs.herokuapp.com/admin`)
// .then(res => {
