...
import Orderedite from '../Admins/confirmOrders';
...
<BrowserRouter>
      ...
      {/* // ______________Client Route__________________ */}
        ...
        <PrivateRouteAdmin  path="/ClientOrder" exact component={Order}/> 
         ...
         <PrivateRouteAdmin  path="/Admins/order/Confirm" exact component={Orderedite}/> 
 {/* Sellers */}
        ...
        <PrivateRouteSeller  path="/Admins/order/Confirm" exact component={EditeProduct}/> 
      </Switch>
</BrowserRouter>
  );
}
