...
useEffect(()=>{
  ...
  axios.get(`https://app-ndoejs.herokuapp.com/product/seller/${name}`)
...
const deleteProduct = (id)=>{
  ...
  if (yesno) {   
axios.delete(`https://app-ndoejs.herokuapp.com/product/delete/${id}`)
.then(function (response) {
            ...
            <ul className="list-reset flex justify-between flex-1 md:flex-none items-center">
              ...
              <li className="flex-1 md:flex-none md:mr-3">
                <div className="relative inline-block">
                  <button onclick="toggleDD('myDropdown')" className="drop-button text-white focus:outline-none"> <span className="pr-2"><i className="em em-robot_face" /></span> Hi, Seller <svg className="h-3 fill-current inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
