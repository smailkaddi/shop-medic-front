...
useEffect(()=>{
  ...
  axios.get(`https://app-ndoejs.herokuapp.com/product/${idProducttobuy}`)
    ...
    <div className="flex shadow-md my-10">
      ...
      <div id="summary" className="w-1/4 px-8 py-10">
        ...
        <div className="border-t mt-8">
          ...
          <Link onClick={() => payment( product2 && product2._id)}><button className="bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Checkout</button></Link>
        </div>
      </div>
    </div>
  </div>
